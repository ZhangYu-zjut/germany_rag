...
if __name__ == "__main__":
    ...
    for i, question_data in enumerate(TEST_QUESTIONS_Q6Q7, 1):
        result = test_one_question(workflow, question_data, total_questions=2)
        logger.info(f"\n{'='*80}")
        logger.info(f"✅ 问题 {i}/2 完成")
